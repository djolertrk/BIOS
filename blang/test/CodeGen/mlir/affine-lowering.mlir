// RUN: %blang %s -emit=mlir-affine 2>&1 | FileCheck %s
// RUN: %blang %s -emit=mlir-affine -opt 2>&1 | FileCheck %s --check-prefix=OPT
...
// CHECK:         "blang.print"([[VAL_6]]) : (memref<3x2xf64>) -> ()
...
// OPT:         "blang.print"([[VAL_6]]) : (memref<3x2xf64>) -> ()
